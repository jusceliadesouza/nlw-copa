...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] mx-auto min-h-screen grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          <button
            className="px-6 py-4 text-gray-900 font-bold uppercase bg-yellow-500 hover:bg-yellow-700 rounded"
            type="submit"
          >
            Criar meu bolão
          </button>
